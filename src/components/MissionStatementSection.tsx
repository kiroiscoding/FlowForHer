...
export const MissionStatementSection = () => {
    ...
    return (
        ...
        <section className="relative h-screen flex items-center justify-center px-6 -mt-[60vh] pb-[20vh] z-20 pointer-events-none">
            ...
            <div className="w-[80vw] max-w-4xl text-center text-brand-cream mt-20">
                <h2 className="font-display text-4xl md:text-6xl lg:text-7xl uppercase leading-tight mb-6">
                    {language === "en" ? (
                        <>
                ...
                <p className="font-sans text-lg md:text-2xl opacity-90 max-w-2xl mx-auto">
                    {language === "en"
