...
export const EDUCATION_MODULES: EducationModule[] = [
  {
    ...
    quiz: [
      ...
      {
        id: "q2",
        questionEn: "A menstrual cycle is always exactly 28 days.",
        questionAr: "الدورة الشهرية دائماً ٢٨ يوماً بالضبط.",
        optionsEn: ["True", "False"],
        optionsAr: ["صحيح", "خطأ"],
        correctIndex: 1,
        explanationEn:
          "No—28 days is a common example, but many healthy cycles are shorter or longer. Tracking helps you learn your pattern.",
        explanationAr:
          "لا—٢٨ يوماً مثال شائع، لكن الكثير من الدورات الصحية أقصر أو أطول. يساعد التتبع على معرفة نمطكِ.",
      },
      {
        id: "q3",
        questionEn: "Which organ sheds its lining during a period?",
        questionAr: "أي عضو يطرح بطانته أثناء الدورة الشهرية؟",
        optionsEn: ["Uterus", "Stomach", "Lungs", "Liver"],
        optionsAr: ["الرحم", "المعدة", "الرئتان", "الكبد"],
        correctIndex: 0,
        explanationEn:
          "The uterus sheds its lining. That lining leaves the body as menstrual blood.",
        explanationAr:
          "الرحم يطرح بطانته. وتخرج هذه البطانة على شكل دم الدورة الشهرية.",
      },
    ],
    glossary: [
      {
  ...
  },
  {
    ...
    quiz: [
      ...
      {
        id: "q2",
        questionEn: "How often should you usually change a pad?",
        questionAr: "عادةً كل كم ساعة يجب تغيير الفوطة؟",
        optionsEn: [
          "Once a day",
          "Every 4–6 hours (or when soaked)",
          "Only if it smells",
          "Never during school",
        ],
        optionsAr: [
          "مرة واحدة يومياً",
          "كل ٤–٦ ساعات (أو عند الامتلاء)",
          "فقط إذا ظهرت رائحة",
          "لا تُغيَّر أبداً في المدرسة",
        ],
        correctIndex: 1,
        explanationEn:
          "A common guideline is every 4–6 hours, but flow varies. Change sooner if it’s soaked or uncomfortable.",
        explanationAr:
          "إرشاد شائع هو كل ٤–٦ ساعات، لكن كمية النزيف تختلف. غيّريها أسرع إذا امتلأت أو سببت انزعاجاً.",
      },
      {
        id: "q3",
        questionEn: "You should avoid washing or bathing during your period.",
        questionAr: "يجب تجنّب الاستحمام أو الاغتسال أثناء الدورة الشهرية.",
        optionsEn: ["True", "False"],
        optionsAr: ["صحيح", "خطأ"],
        correctIndex: 1,
        explanationEn:
          "False—washing is safe and can help you feel clean and comfortable. Use gentle products and clean water.",
        explanationAr:
          "خطأ—الاستحمام آمن وقد يساعد على الشعور بالنظافة والراحة. استخدمي ماءً نظيفاً ومنتجات لطيفة.",
      },
    ],
    glossary: [
      {
  ...
  },
  {
    ...
    quiz: [
      {
        id: "q1",
        questionEn: "Which is the best response to a period myth?",
        questionAr: "ما أفضل رد على خرافة حول الدورة الشهرية؟",
        optionsEn: [
          "Repeat it so everyone hears it",
          "Ask questions and share accurate facts kindly",
          "Tell people to stay silent",
          "Shame the person who asked",
        ],
        optionsAr: [
          "تكرارها حتى يسمعها الجميع",
          "طرح أسئلة ومشاركة حقائق صحيحة بلطف",
          "مطالبة الناس بالصمت",
          "إحراج الشخص الذي سأل",
        ],
        correctIndex: 1,
        explanationEn:
          "Kind, accurate information helps replace rumors with understanding—without creating more shame.",
        explanationAr:
          "المعلومات الصحيحة بلطف تساعد على استبدال الشائعات بالفهم—بدون زيادة العار.",
      },
      {
        id: "q2",
      ...
      {
        id: "q3",
        questionEn: "Exercise is always dangerous during a period.",
        questionAr: "الرياضة دائماً خطرة أثناء الدورة الشهرية.",
        optionsEn: ["True", "False"],
        optionsAr: ["صحيح", "خطأ"],
        correctIndex: 1,
        explanationEn:
          "False—many people can exercise safely. Listen to your body and choose gentle movement if needed.",
        explanationAr:
          "خطأ—يمكن للكثيرات ممارسة الرياضة بأمان. استمعي لجسمكِ واختاري حركة خفيفة إذا لزم الأمر.",
      },
    ],
    glossary: [],
  },
  {
    ...
    quiz: [
      ...
      {
        id: "q2",
        questionEn: "Which food is a good source of iron?",
        questionAr: "أي طعام يُعد مصدراً جيداً للحديد؟",
        optionsEn: ["Lentils or beans", "Candy", "Soda", "Chips"],
        optionsAr: ["العدس أو الفاصوليا", "الحلوى", "المشروبات الغازية", "رقائق البطاطس"],
        correctIndex: 0,
        explanationEn:
          "Lentils/beans can provide iron. Pairing iron foods with vitamin C can help absorption.",
        explanationAr:
          "العدس/الفاصوليا يمكن أن يوفر الحديد. وقد يساعد فيتامين C على امتصاص الحديد.",
      },
      {
        id: "q3",
        questionEn: "If you feel tired, it can never be related to your period.",
        questionAr: "إذا شعرتِ بالتعب، فلا يمكن أن يكون له علاقة بالدورة الشهرية أبداً.",
        optionsEn: ["True", "False"],
        optionsAr: ["صحيح", "خطأ"],
        correctIndex: 1,
        explanationEn:
          "False—some people feel more tired during their cycle, especially with heavy bleeding. If fatigue is severe or persistent, seek help.",
        explanationAr:
          "خطأ—قد تشعر بعض الفتيات بتعب أكثر خلال الدورة، خصوصاً مع نزيف غزير. إذا كان التعب شديداً أو مستمراً، اطّلبي المساعدة.",
      },
    ],
    glossary: [],
  },
  {
    ...
    quiz: [
      ...
      {
        id: "q2",
        questionEn: "Which is a helpful self-care strategy during PMS?",
        questionAr: "ما استراتيجية رعاية ذاتية مفيدة أثناء أعراض ما قبل الدورة؟",
        optionsEn: ["Gentle movement and rest", "Skipping all meals", "Not sleeping at all", "Hiding symptoms and suffering alone"],
        optionsAr: ["حركة خفيفة وراحة", "تجاهل الطعام تماماً", "عدم النوم إطلاقاً", "إخفاء الأعراض والمعاناة وحدكِ"],
        correctIndex: 0,
        explanationEn:
          "Gentle routines—sleep, hydration, movement, and support—can make symptoms more manageable.",
        explanationAr:
          "الروتين اللطيف—النوم، الماء، الحركة، والدعم—قد يجعل الأعراض أسهل.",
      },
      {
        id: "q3",
  ...
  },
  {
    ...
    quiz: [
      ...
      {
        id: "q2",
        questionEn: "What’s the best first step when advocating for menstrual health?",
        questionAr: "ما أفضل خطوة أولى في المناصرة لصحة الدورة الشهرية؟",
        optionsEn: ["Start with respect and facts", "Spread rumors to get attention", "Blame people for needing supplies", "Make it a secret topic"],
        optionsAr: ["البدء بالاحترام والحقائق", "نشر شائعات لجذب الانتباه", "لوم الناس على حاجتهم للمستلزمات", "جعل الموضوع سرياً"],
        correctIndex: 0,
        explanationEn:
          "Respect and accurate information build trust and reduce stigma—this is how change starts.",
        explanationAr:
          "الاحترام والمعلومات الصحيحة يبنيان الثقة ويقللان الوصمة—وهكذا يبدأ التغيير.",
      },
      {
        id: "q3",
        questionEn: "Advocacy only counts if it’s big and public.",
        questionAr: "المناصرة لا تُعتبر إلا إذا كانت كبيرة وعلنية.",
        optionsEn: ["True", "False"],
        optionsAr: ["صحيح", "خطأ"],
        correctIndex: 1,
        explanationEn:
          "False—small steps matter: one conversation, one friend, one classroom. Change spreads through communities.",
        explanationAr:
          "خطأ—الخطوات الصغيرة مهمة: محادثة واحدة، صديقة واحدة، صف واحد. التغيير ينتشر داخل المجتمع.",
      },
    ],
    glossary: [],
  },
