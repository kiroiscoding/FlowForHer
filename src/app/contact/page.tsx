    ...
    <div className="min-h-screen bg-brand-dark-green text-brand-cream font-sans">
      <div className="pt-32 pb-20 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          {/* Info Section */}
          <div>
            <h1 className="font-display text-6xl md:text-8xl uppercase mb-8 leading-none">
              Get In <br /> Touch
            </h1>
            <p className="text-xl md:text-2xl font-light opacity-80 max-w-md leading-relaxed mb-12">
